 ...
 */
function createFetchLanguageModel(url, headers, defaultParams) {
    const model = {
        complete
    };
    return model;
        ...
        while (true) {
            ...
            if (response.ok) {
                ...
                if (typeof json.choices[0].message.content === "string") {
                    return (0, result_1.success)(json.choices[0].message.content ?? "");
                }
                else {
                    return (0, result_1.error)(`REST API unexpected response format: ${JSON.stringify(json.choices[0].message.content)}`);
                }
            }
