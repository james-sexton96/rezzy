...
Deno.test({
  ...
  fn: () => {
    ...
    assertEquals(
      ...
      true,
      "Resume should contain the location",
    );
    assertEquals(
      latexString.includes("Tech Company"),
      true,
      "Resume should contain the company name",
    );
    assertEquals(
      latexString.includes("University"),
      true,
      "Resume should contain the education institution",
    );
    assertEquals(
      latexString.includes("Computer Science"),
      true,
      "Resume should contain the education area",
    );
    assertEquals(
      latexString.includes("JavaScript"),
      true,
      "Resume should contain the skills",
    );
    assertEquals(
      latexString.includes("Areas of Expertise"),
      true,
      "Resume should contain the interests section",
    );
...
Deno.test({
  ...
  fn: () => {
    ...
    // Verify that the LaTeX contains expected elements
    assertEquals(
      latexString.includes("Jane Smith"),
      true,
      "Resume should contain the name",
    );
    assertEquals(
      latexString.includes("jane@example.com"),
      true,
      "Resume should contain the email",
    );
